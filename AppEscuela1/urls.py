...
urlpatterns = [
    ...
    path('estudiantes/', lista_estudiantes.as_view(), name='lista_estudiantes'),
    path('estudiantes/nuevo/', crear_estudiante.as_view(), name='crear_estudiante'),     
    ...
    path('profesores/', lista_profesores.as_view(), name='lista_profesores'),
    path('profesores/nuevo/', crear_profesor.as_view(), name='crear_profesor'),    
    ...
    path('cursos/', lista_cursos.as_view(), name='lista_cursos'),
    path('cursos/nuevo/', crear_curso.as_view(), name='crear_curso'),    
    ...
    path('entregables/', lista_entregable.as_view(), name='lista_entregables'),
    path('entregables/nuevo/', crear_entregable.as_view(), name='crear_entregable'),    
